...
THEOREM SpecTypeOK == Spec => []TypeOK
    ...
    <1>2. TypeOK /\ [Next]_vars => TypeOK'
        ...
        <2>2. CASE WriteReq2 
            ...
            <3>1. messages' \in SUBSET MessagesType PROOF OBVIOUS
            <3>2. processorTimestamps' \in [Processors -> Nat] PROOF OBVIOUS
            <3>3. processorValues' \in [Processors -> Values \cup {Default}] PROOF OBVIOUS
            <3>4. lastTimestamp' \in Nat PROOF OBVIOUS
            <3>5. lastOperationNumber \in Nat PROOF BY <2>2 DEF Next, WriteReq2, SendWriteReq
